...
const messages = defineMessages({
  ...
  resetAllUnits: {
    ...
    defaultMessage: 'Đặt lại tất cả các đơn vị',
  },
  resetAllUnitsTooltipChecked: {
    id: 'course-authoring.pages-resources.app-settings-modal.reset-all-units-tooltip.checked',
    defaultMessage: 'Ngay lập tức đặt lại mọi thay đổi ở cấp độ đơn vị và đánh dấu chọn "Bật tóm tắt" trên tất cả các đơn vị.',
  },
  resetAllUnitsTooltipUnchecked: {
    id: 'course-authoring.pages-resources.app-settings-modal.reset-all-units-tooltip.unchecked',
    defaultMessage: 'Ngay lập tức đặt lại mọi thay đổi ở cấp độ đơn vị và bỏ đánh dấu chọn "Bật tóm tắt" trên tất cả các đơn vị.',
  },
  reset: {
